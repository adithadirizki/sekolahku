   ...
   <div class="col-lg-12 m-auto">
      <div class="card">
         <div class="card-body">
            ...
            <form id="add-material" enctype="multipart/form-data" onsubmit="return false;">
               <div class="form-group">
                  <label for="material_title">Judul Materi <span class="text-danger font-small-4">*</span></label>
                  <input type="text" class="form-control" name="material_title" id="material_title" placeholder="Judul Materi" required>
...
<script>
   $(document).ready(function() {
      ...
      $(document).on('submit', '#add-material', function(e) {
         e.preventDefault();
