         ...
         <div class="row">
            ...
            <div class="col-lg-4 mb-2">
               ...
               <div class="form-group">
                  ...
                  <select name="teaching_class[]" id="teaching_class" class="form-control" multiple>
               ...
               <div class="form-group">
                  ...
                  <select name="teaching_subject[]" id="teaching_subject" class="form-control" multiple>
                     <?php foreach ($subject as $v) { ?>
                        <option value="<?= $v->subject_id ?>" selected><?= $v->subject_name ?></option>
                     <?php } ?>
                  </select>
                  <div class="invalid-feedback"></div>
               </div>
