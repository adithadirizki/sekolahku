   ...
   <div class="col-lg-12 m-auto">
      <div class="card">
         <div class="card-body">
            ...
            <form id="edit-announcement" enctype="multipart/form-data" onsubmit="return false;">
               <div class="form-group">
                  <label for="announcement_title">Judul Materi <span class="text-danger font-small-4">*</span></label>
                  <input type="text" class="form-control" name="announcement_title" id="announcement_title" value="<?= $data->announcement_title ?>" placeholder="Judul Materi" required>
               ...
               <div class="row">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="announced_at" id="announced_at" value="<?= (new DateTime($data->announced_at))->format('Y-m-d\TH:i') ?>" required>
                        <div class="invalid-feedback"></div>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input type="datetime-local" class="form-control" name="announced_until" id="announced_until" value="<?= (new DateTime($data->announced_until))->format('Y-m-d\TH:i') ?>" required>
                        <div class="invalid-feedback"></div>
                     </div>
                  </div>
               </div>
...
<script>
   $(document).ready(function() {
      ...
      $('#announcement_for').val("<?= $data->announcement_for ?>").trigger('change');
      $(document).on('submit', '#edit-announcement', function(e) {
         e.preventDefault();
            ...
            success: function(result) {
               ...
               if (result.error == false) {
                  Swal.fire({
                     ...
                     window.location.href = "<?= base_url('announcement/' . $data->announcement_id) ?>";
                  })
