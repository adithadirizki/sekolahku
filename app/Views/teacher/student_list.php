         ...
         columns: [{
            ...
            },
            {
               ...
               "mRender": function(username, row, data) {
                  return '<div class="d-flex justify-content-left align-items-center"><div class="avatar-wrapper"></div><div class="d-flex flex-column"><a href="javascript:void(0);" class="student_name text-truncate"><span class="font-weight-bold">' + data.fullname + '</span>&nbsp;</a><small class="emp_post text-muted">@' + username + '</small></div></div>';
               }
            },
            {
               "data": "nis",
